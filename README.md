...
Note: The shell script currently contains a typo in its internal file reference (`zs_thnnnig.py` instead of `zs_thinning.py`). Please correct this in `run-zs-thinning.sh` before running the commands above.
